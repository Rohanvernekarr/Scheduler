    ...
    <div className="min-h-screen bg-black text-white selection:bg-white/10 flex flex-col md:flex-row">
      <div className="hidden md:flex md:w-1/2 bg-[#0d0d0d] border-r border-white/5 flex-col justify-between p-16 relative overflow-hidden">
        <div className="relative z-10">
          ...
          >
            Experience the industrial-grade meeting coordination system. Zero friction, total control.
          </motion.p>
        </div>
        ...
        <div className="relative z-10">
          <div className="grid grid-cols-3 gap-8">
            {[
              { icon: Clock, text: "Instant Slots" },
              { icon: CheckCircle2, text: "Auto Sync" },
              { icon: Calendar, text: "Smart Invites" }
            ].map((item, i) => (
              <motion.div 
                key={i}
                initial={{ opacity: 0 }}
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8 md:p-20 relative bg-black">
        ...
        <div className="w-full max-w-sm space-y-8">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold italic uppercase tracking-tighter">Welcome Boss!</h1>
            <p className="text-zinc-500 text-sm">Enter your details to access your dashboard.</p>
          </div>
              ...
              {!otpSent ? (
                ...
                >
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-white text-black py-4 rounded-2xl font-bold hover:bg-zinc-200 transition-all active:scale-[0.98] shadow-2xl shadow-white/5 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {googleLoading ? (
